...
rcenterx=128/2; %rink center in x
rcentery=96/2; %rink center in y
...
for i=n:size(rawStarData)
    ...
    if ((x(top) < 1023) && (x(bottom) < 1023))
        ...
        %bottom)
        posx(p)=((128/1023)*((x(top)+x(bottom))/2))-rcenterx;
        posy(p)=((96/1023)*((y(top)+y(bottom))/2))-rcentery;
    ...
    elseif ((x(top) < 1023) && (x(left) < 1023))
        ...
        posx(p)=rcenterx-(128/1023)*(x(top)-dcenter*sin(theta-beta));
        posy(p)=rcentery-(96/1023)*(y(top)+0.5*dcenter*cos(theta-beta));
    ...
    elseif ((x(top) < 1023) && (x(right) < 1023))
        ...
        posx(p)=rcenterx-(128/1023)*(x(top)+0.5*dcenter*sin(theta-beta));
        posy(p)=rcentery-(96/1023)*(y(top)-0.5*dcenter*cos(theta-beta));
    ...
    elseif ((x(bottom) < 1023) && (x(left) < 1023))
        ...
        posx(p)=rcenterx-(128/1023)*(x(bottom)+dcenter*sin(theta-beta));
        posy(p)=rcentery-(96/1023)*(y(bottom)-dcenter*cos(theta-beta));
    ...
    elseif ((x(bottom) < 1023) && (x(right) < 1023))
        ...
        theta=atan2(11.655,14.5-8.741);
        posx(p)=rcenterx-(128/1023)*(x(bottom)+0.5*dcenter*sin(theta-beta));
        posy(p)=rcentery-(96/1023)*(y(bottom)-0.5*dcenter*cos(theta-beta));
