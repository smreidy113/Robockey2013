...
WII_Log = zeros(9,2);   % IMU data points logged here in format: [time ADC_Value]
WII_live_plot_log = zeros(maxPoints,1); % Create an array to store ADC values.
...
%For general use
     [m2_x, remain] = str2num(strtok(m2_buffer));
